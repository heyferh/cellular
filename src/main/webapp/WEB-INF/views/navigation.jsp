...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="../../app/css/plugins/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- DataTables CSS -->
    <link href="../../app/css/plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="../../app/css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="../../app/font-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<script src="../../app/js/plugins/metisMenu/metisMenu.min.js"></script>

<!-- DataTables JavaScript -->
<script src="../../app/js/plugins/dataTables/jquery.dataTables.js"></script>
<script src="../../app/js/plugins/dataTables/dataTables.bootstrap.js"></script>
